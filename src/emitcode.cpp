...
// 
void emitComment(string str, string ss)
{
    fprintf(code, "* %s %s\n", str.c_str(), ss.c_str());
}


void emitComment(string str, int n)
{
    fprintf(code, "* %s %d\n", str.c_str(), n);
}
...
// c = a comment
// 
void emitRO(string op, long long int r, long long int s, long long int t, string str, string ss)
{
    fprintf(code, "%3d:  %5s  %lld,%lld,%lld\t%s %s\n", emitLoc, op.c_str(), r, s, t, str.c_str(), ss.c_str());
    fflush(code);
    emitLoc++;
}

void emitRO(string op,long long int r,long long int s,long long int t, string str)
{
    emitRO(op, r, s, t, str, "");
}
...
// c = a comment
// 
void emitRM(string op, long long int r, long long int d, long long int s, string str, string ss)
{
    fprintf(code, "%3d:  %5s  %lld,%lld(%lld)\t%s %s\n", emitLoc, op.c_str(), r, d, s, str.c_str(), ss.c_str());
    fflush(code);
    emitLoc++;
}

void emitRM(string op,long long int r,long long int d,long long int s, string str)
{
    emitRM(op, r, d, s, str, "");
}


void emitGoto(int d,long long int s, string str, string ss)
{
    emitRM("JMP", (long long int)PC, d, s, str, ss);
}


void emitGoto(int d,long long int s, string str)
{
    emitGoto(d,  s, str, "");
}
...
// c = a comment
// 
void emitRMAbs(string op, long long int r, long long int a, string str, string ss)
{
    fprintf(code, "%3d:  %5s  %lld,%lld(%lld)\t%s %s\n", emitLoc, op.c_str(), r, a - (long long int)(emitLoc + 1),
	    (long long int)PC, str.c_str(), ss.c_str());
    fflush(code);
    emitLoc++;
}


void emitRMAbs(string op,long long int r,long long int a, string str)
{
    emitRMAbs(op, r, a, str, "");
}


void emitGotoAbs(int a, string str, string ss)
{
    emitRMAbs("JMP", (long long int)PC, a, str, ss);
}


void emitGotoAbs(int a, string str)
{
    emitGotoAbs(a, str, "");
}
...
int emitStrLit(int goffset, string s)
{
